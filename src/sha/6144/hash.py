class SHA6144:
    """SHA-6144 hash implementation with optional salt support."""
    ...
    def __init__(self):
        """Init SHA-6144 with initial hash values."""
        self.h = [
            ...
            0xa2bfe8a1415d7a9c, 0x0c2e4d6f8a1b3c5d, 0x1d3e5f7a9b2c4d6e, 0x2e4f6a8b9c3d5e7f,
            0x3f5a6b8c9d4e6f8a, 0x4a6b7c8d9e5f7a8b, 0x5b7c8d9e0f6a8b9c, 0x6c8d9e0f1a7b9c0d,
            0x7d9e0f1a2b8c0d1e, 0x8e0f1a2b3c9d1e2f, 0x9f1a2b3c4d0e2f3a, 0x0a2b3c4d5e1f3a4b,
            0x1b3c4d5e6f2a4b5c, 0x2c4d5e6f7a3b5c6d, 0x3d5e6f7a8b4c6d7e, 0x4e6f7a8b9c5d7e8f,
            0x5f7a8b9c0d6e8f9a, 0x6a8b9c0d1e7f9a0b, 0x7b9c0d1e2f8a0b1c, 0x8c0d1e2f3a9b1c2d,
            0x9d1e2f3a4b0c2d3e, 0x0e2f3a4b5c1d3e4f, 0x1f3a4b5c6d2e4f5a, 0x2a4b5c6d7e3f5a6b,
            0x3b5c6d7e8f4a6b7c, 0x4c6d7e8f9a5b7c8d, 0x5d7e8f9a0b6c8d9e, 0x6e8f9a0b1c7d9e0f,
            0x7f9a0b1c2d8e0f1a, 0x8a0b1c2d3e9f1a2b, 0x9b1c2d3e4f0a2b3c, 0x0c2d3e4f5a1b3c4d,
            0x1d3e4f5a6b2c4d5e, 0x2e4f5a6b7c3d5e6f, 0x3f5a6b7c8d4e6f7a, 0x4a6b7c8d9e5f7a8b,
            0x5b7c8d9e0f6a8b9c, 0x6c8d9e0f1a7b9c0d, 0x7d9e0f1a2b8c0d1e, 0x8e0f1a2b3c9d1e2f,
            0x9f1a2b3c4d0e2f3a, 0x0a2b3c4d5e1f3a4b, 0x1b3c4d5e6f2a4b5c, 0x2c4d5e6f7a3b5c6d,
            0x3d5e6f7a8b4c6d7e, 0x4e6f7a8b9c5d7e8f, 0x5f7a8b9c0d6e8f9a, 0x6a8b9c0d1e7f9a0b,
            0x7b9c0d1e2f8a0b1c, 0x8c0d1e2f3a9b1c2d, 0x9d1e2f3a4b0c2d3e, 0x0e2f3a4b5c1d3e4f,
            0x1f3a4b5c6d2e4f5a, 0x2a4b5c6d7e3f5a6b, 0x3b5c6d7e8f4a6b7c, 0x4c6d7e8f9a5b7c8d,
            0x5d7e8f9a0b6c8d9e, 0x6e8f9a0b1c7d9e0f, 0x7f9a0b1c2d8e0f1a, 0x8a0b1c2d3e9f1a2b,
            0x9b1c2d3e4f0a2b3c, 0x0c2d3e4f5a1b3c4d, 0x1d3e4f5a6b2c4d5e, 0x2e4f5a6b7c3d5e6f
        ]
    ...
    def _pad_message(self, message):
        """Pad message according to SHA-6144 specification."""
        msg_len = len(message)
        message += b'\x80'
    ...
    def _process_chunk(self, chunk):
        ...
        for i in range(16, 1536):
            w[i] = (self._gamma1(w[i-2]) + w[i-7] + self._gamma0(w[i-15]) + w[i-16]) & 0xFFFFFFFFFFFFFFFF

        a, b, c, d, e, f, g, h, i_val, j, k, l, m, n, o, p, q, r, s, t, u, v, w_val, x, y, z, aa, ab, ac, ad, ae, af, ag, ah, ai, aj, ak, al, am, an, ao, ap, aq, ar, as_val, at, au, av, aw, ax, ay, az, ba, bb, bc, bd, be, bf, bg, bh, bi, bj, bk, bl, bm, bn, bo, bp, bq, br, bs, bt, bu, bv, bw, bx, by, bz, ca, cb, cc, cd, ce, cf, cg, ch, ci, cj, ck, cl, cm, cn, co, cp, cq, cr = self.h

        for i in range(1536):
            t1 = (cr + self._sigma1(e) + self._ch(e, f, g) + self.K[i % len(self.K)] + w[i]) & 0xFFFFFFFFFFFFFFFF
    ...
    def hash(self, message):
        """
        Compute SHA-6144 hash of message.
    ...
    def hash_with_salt(self, message, salt):
        """
        Compute SHA-6144 hash with salt (prepended to message).
