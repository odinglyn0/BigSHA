class SHA8192:
    """SHA-8192 hash implementation with optional salt support."""
    ...
    def __init__(self):
        """Init SHA-8192 with initial hash values."""
        self.h = [
            ...
            0x304152637485a6b7, 0x4152637485a6b7c8, 0x52637485a6b7c8d9, 0x637485a6b7c8d9ea,
            0x7485a6b7c8d9eafb, 0x85a6b7c8d9eafb0c, 0xa6b7c8d9eafb0c1d, 0xb7c8d9eafb0c1d2e,
            0xc8d9eafb0c1d2e3f, 0xd9eafb0c1d2e3f40, 0xeafb0c1d2e3f4051, 0xfb0c1d2e3f405162,
            0x0c1d2e3f40516273, 0x1d2e3f4051627384, 0x2e3f405162738495, 0x3f4051627384a5b6,
            0x4051627384a5b6c7, 0x51627384a5b6c7d8, 0x627384a5b6c7d8e9, 0x7384a5b6c7d8e9fa,
            0x84a5b6c7d8e9fa0b, 0xa5b6c7d8e9fa0b1c, 0xb6c7d8e9fa0b1c2d, 0xc7d8e9fa0b1c2d3e,
            0xd8e9fa0b1c2d3e4f, 0xe9fa0b1c2d3e4f50, 0xfa0b1c2d3e4f5061, 0x0b1c2d3e4f506172
        ]
    ...
    def _pad_message(self, message):
        """Pad message according to SHA-8192 specification."""
        msg_len = len(message)
        message += b'\x80'
    ...
    def _process_chunk(self, chunk):
        ...
        self.h[104] = (self.h[104] + da) & 0xFFFFFFFFFFFFFFFF
        self.h[105] = (self.h[105] + db) & 0xFFFFFFFFFFFFFFFF
        self.h[106] = (self.h[106] + dc) & 0xFFFFFFFFFFFFFFFF
        self.h[107] = (self.h[107] + dd) & 0xFFFFFFFFFFFFFFFF
        self.h[108] = (self.h[108] + de) & 0xFFFFFFFFFFFFFFFF
        self.h[109] = (self.h[109] + df) & 0xFFFFFFFFFFFFFFFF
        self.h[110] = (self.h[110] + dg) & 0xFFFFFFFFFFFFFFFF
        self.h[111] = (self.h[111] + dh) & 0xFFFFFFFFFFFFFFFF
        self.h[112] = (self.h[112] + di) & 0xFFFFFFFFFFFFFFFF
        self.h[113] = (self.h[113] + dj) & 0xFFFFFFFFFFFFFFFF
        self.h[114] = (self.h[114] + dk) & 0xFFFFFFFFFFFFFFFF
        self.h[115] = (self.h[115] + dl) & 0xFFFFFFFFFFFFFFFF
        self.h[116] = (self.h[116] + dm) & 0xFFFFFFFFFFFFFFFF
        self.h[117] = (self.h[117] + dn) & 0xFFFFFFFFFFFFFFFF
        self.h[118] = (self.h[118] + do) & 0xFFFFFFFFFFFFFFFF
        self.h[119] = (self.h[119] + dp) & 0xFFFFFFFFFFFFFFFF
        self.h[120] = (self.h[120] + dq) & 0xFFFFFFFFFFFFFFFF
        self.h[121] = (self.h[121] + dr) & 0xFFFFFFFFFFFFFFFF
        self.h[122] = (self.h[122] + ds) & 0xFFFFFFFFFFFFFFFF
        self.h[123] = (self.h[123] + dt) & 0xFFFFFFFFFFFFFFFF
        self.h[124] = (self.h[124] + du) & 0xFFFFFFFFFFFFFFFF
        self.h[125] = (self.h[125] + dv) & 0xFFFFFFFFFFFFFFFF
        self.h[126] = (self.h[126] + dw) & 0xFFFFFFFFFFFFFFFF
        self.h[127] = (self.h[127] + dx) & 0xFFFFFFFFFFFFFFFF
    
    def hash(self, message):
        """
        Compute SHA-8192 hash of message.
    ...
    def hash_with_salt(self, message, salt):
        """
        Compute SHA-8192 hash with salt (prepended to message).
