class SHA256:
    """SHA-256 hash implementation with optional salt support."""
    ...
    def __init__(self):
        """Init SHA-256 with initial hash values."""
        self.h = [
    ...
    def _process_chunk(self, chunk):
        ...
        for i in range(64):
            t1 = (d + self._sigma1(a) + self._ch(a, b, c) + self.K[i % len(self.K)] + w[i]) & 0xFFFFFFFFFFFFFFFF
    ...
    def hash_with_salt(self, message, salt):
        """
        Compute SHA-256 hash with salt (prepended to message).
